...
sealed class BYOKDemo(ILogger<CopilotClient> logger)
{
    ...
    Task Step2_ListModels(IReadOnlyList<ModelInfo> models)
    {
        ...
        Console.WriteLine("  (Admin agrega API keys en: GitHub > Enterprise > AI controls > Copilot > Custom models)");
        Console.WriteLine();
